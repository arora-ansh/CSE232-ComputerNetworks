...
main (int argc, char *argv[])
{
  ...
  std::string bandwidth_1 = "10Mbps";
  std::string bandwidth_2 = "5Mbps";
  std::string delay_1 = "10ms";
  std::string delay_2 = "15ms";
  std::string queuesize = "10p";
  int packetsize = 1460; // bytes
  ...
  pointToPoint.SetDeviceAttribute ("DataRate", StringValue (bandwidth_1));
  pointToPoint.SetChannelAttribute ("Delay", StringValue (delay_1));
  ...
  pointToPoint2.SetDeviceAttribute ("DataRate", StringValue (bandwidth_2));
  pointToPoint2.SetChannelAttribute ("Delay", StringValue (delay_2));
...
Ipv4AddressHelper address2;
  ...
  app->Setup (ns3TcpSocket, sinkAddress, packetsize, 1000000, DataRate ("100Mbps"));
